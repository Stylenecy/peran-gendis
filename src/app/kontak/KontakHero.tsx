...
const TEAL = "#06b6d4";
const TEAL_GLOW = "rgba(6,182,212,0.12)";
const TEAL_DIM = "rgba(6,182,212,0.50)";
const TEAL_LINE = "rgba(6,182,212,0.2)";

export default function KontakHero() {
  return (
    <section className="relative z-10 min-h-[75vh] flex flex-col justify-center overflow-hidden px-6 pt-28 pb-16 max-w-6xl mx-auto">
      {/* Teal radial glow */}
      <div
        className="absolute inset-0 pointer-events-none -z-10"
        style={{
          background: `radial-gradient(ellipse 65% 55% at 10% 60%, ${TEAL_GLOW} 0%, transparent 70%)`,
        }}
      />
      ...
      >
        Mau daftar GeMar, jadi volunteer, jadi sponsor, atau sekadar ingin tahu
        lebih banyak — kami terbuka.
      </motion.p>

...
export default function KontakContacts() {
  return (
    <section className="relative z-20 max-w-6xl mx-auto px-6 pb-32 pt-4">
      {/* Section header */}
      <motion.div
      ...
      >
        ...
        <div className="h-12 border-b border-white/5 bg-black/40 px-5 flex items-center justify-between">
          ...
          <span className="text-xs font-semibold tracking-wider" style={{ color: `rgba(6,182,212,0.55)` }}>
            Kontak — Peran Gendis
          </span>
          <div className="w-12" />
        </div>

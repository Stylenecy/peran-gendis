  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: "radial-gradient(ellipse 60% 50% at 50% 50%, #fbe9f2 0%, transparent 70%)" }}
      />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 pt-32 pb-20 flex flex-col items-center text-center">
        <motion.span
          ...
          style={{ color: "var(--color-pg-berry-deep)", borderLeft: "2px solid var(--color-pg-berry-deep)", paddingLeft: "1rem", alignSelf: "flex-start" }}
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        <div className="mb-6 relative">
          ...
          <motion.div
            ...
            style={{ background: "var(--color-pg-berry-deep)", maxWidth: "200px" }}
            initial={{ width: 0 }}
            animate={{ width: "100%" }}
        ...
        >
          Isu sosial layak<br />
          <span style={{ color: "var(--color-pg-berry-deep)" }}>dicatat. Dibaca.</span>
        </motion.h1>
        ...
        >
          <div className="px-5 py-2.5 border text-sm font-bold" style={{ borderColor: "var(--color-pg-paper-3)", color: "var(--color-pg-berry)" }}>
            Artikel Opini
          </div>

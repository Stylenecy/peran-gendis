...
export default function KoperHero() {
  return (
    <section
      className="relative min-h-screen flex flex-col justify-center overflow-hidden"
      style={{ background: "#0d0118" }}
    >
      <div className="absolute inset-0 pointer-events-none bg-[radial-gradient(ellipse_60%_50%_at_50%_50%,rgba(59,18,99,0.45)_0%,transparent_70%)]" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 pt-32 pb-20 flex flex-col items-center text-center">
        ...
        >
          project per tahun — wawancara, diskusi, dan audiensi langsung
        </motion.p>
        <motion.p
        ...
        >
          Komunitas yang<br />
          <span style={{ color: "#d97706" }}>berbicara jujur.</span>
        </motion.h1>
        ...
        >
          Ruang aman diskusi bagi perempuan dan kelompok marginal — dalam format reels, audiensi, dan dialog terbuka.
        </motion.p>

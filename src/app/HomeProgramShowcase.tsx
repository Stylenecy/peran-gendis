...
const programs = [
  {
    id: "gemar",
    name: "GeMar",
    fullName: "Gendis Mengajar",
    label: "Aktif",
    labelColor: "#d97706",
    avatarBg: "from-amber-600 to-amber-900",
    avatarText: "G",
    preview: "Kelas bimbel gratis untuk anak TK-SD agar belajar jadi menyenangkan...",
    time: "17 Mei 2026",
    unread: true,
    summary:
      "GeMar bergerak di 5 lokasi aktif sejak 17 Mei 2026. Program ini menyediakan kelas bimbingan belajar gratis untuk anak TK-SD setiap minggu.",
    body: [
      "GeMar adalah program kelas bimbingan belajar (bimbel) gratis yang dirancang untuk anak-anak usia TK hingga SD.",
      "Saat ini aktif di 5 lokasi dengan sesi mingguan yang terbuka untuk umum. Volunteer pengajar sangat kami sambut.",
      "Program mencakup: pendampingan belajar mata pelajaran, sesi belajar interaktif yang menyenangkan, dan penanaman nilai kesetaraan sejak dini.",
    ],
    stats: [
      { v: "5", l: "Lokasi Aktif" },
      { v: "16", l: "Volunteer" },
